  ...
  return (
    <section className="site-section py-8 md:py-24 bg-zinc-950 relative overflow-hidden" aria-labelledby="certifications-heading">
      ...
      <div className="site-container relative z-10">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto mb-6 sm:mb-20">
          <div className="mb-6 sm:mb-8 inline-flex items-center gap-2 rounded-full border border-accent/30 bg-accent/10 px-4 py-1.5 sm:px-5 sm:py-2 text-[10px] sm:text-xs font-bold tracking-[0.2em] text-accent/90 shadow-sm backdrop-blur-sm">
        ...
        <div className="mt-8 sm:mt-24">
          <p className="mb-4 sm:mb-10 text-center text-[10px] sm:text-xs font-bold uppercase tracking-[0.3em] text-zinc-500">
